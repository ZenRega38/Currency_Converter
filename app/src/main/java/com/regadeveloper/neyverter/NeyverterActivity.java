package com.regadeveloper.neyverter;
...
public class NeyverterActivity extends AppCompatActivity {
    EditText input_uang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neyverter);
        ...
        rp_pounds= findViewById(R.id.rpounds);
    }
    public boolean cek(){
